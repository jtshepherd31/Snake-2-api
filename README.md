...
1. Replace all instances of `snake-2-api` with your application name. **This includes the folder included in this repository.**
...
This template includes a project `snake-2-api` which should be renamed
...
all instances of `snake-2-api` with your app's name.
